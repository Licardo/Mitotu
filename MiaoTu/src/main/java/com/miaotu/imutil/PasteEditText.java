...
//                clip.setText("");
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        if(!TextUtils.isEmpty(text) && text.toString().startsWith(ChatsActivity.COPY_IMAGE)){
            setText("");
        }
