...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatsActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatsActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		if (isPlaying) {
			if (((ChatsActivity) activity).playMsgId != null && ((ChatsActivity) activity).playMsgId.equals(message.getMsgId())) {
