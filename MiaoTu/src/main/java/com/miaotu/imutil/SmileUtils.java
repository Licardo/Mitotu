...
import com.miaotu.R;
import com.miaotu.util.VerticalImageSpan;
...
//	public static final String ee_35 = "[(D)]";
	...
	public static boolean addSmiles(Context context, Spannable spannable) {
	    ...
	    for (Entry<Pattern, Integer> entry : emoticons.entrySet()) {
	        ...
	        while (matcher.find()) {
	            boolean set = true;
	            for (VerticalImageSpan span : spannable.getSpans(matcher.start(),
	                    matcher.end(), VerticalImageSpan.class))
	            ...
	            if (set) {
	                hasChanges = true;
	                spannable.setSpan(new VerticalImageSpan(context, entry.getValue()),
