...
public class RemindLikeTogetherFragment extends BaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root = inflater.inflate(R.layout.fragment_remind_like_together,null);
        findView();
        bindView();
        init();
        return root;
